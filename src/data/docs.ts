...
export const docSections: DocSection[] = [
  ...
  /* 2. Strudel Basics */
  {
    ...
    content: [
      ...
      { type: 'code', code: 'sound("bd sd [hh hh] sd").bank("RolandTR808")' },
  ...
  /* 4. Sounds & Samples */
  {
    ...
    content: [
      ...
      { type: 'code', code: 'sound("bd sd hh sd").bank("RolandTR808")\nsound("bd sd hh sd").bank("RolandTR909")' },
  ...
  /* 6. Pattern Tricks */
  {
    ...
    content: [
      ...
      { type: 'code', code: 'sound("bd(3,8)").bank("RolandTR808")\nsound("sd(2,5)").bank("RolandTR909")' },
    ],
  },
